...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nav-item:hover  { background: rgba(26,110,247,0.1); color: var(--text-primary); }
        .nav-item.active { background: rgba(26,110,247,0.15); color: var(--blue-2); border: 1px solid rgba(26,110,247,0.2); }
        ...
        .btn-logout:hover { background: rgba(255,78,106,0.2); }
        ...
        .main {
            ...
            min-width: 0;
            background:
                radial-gradient(ellipse 80% 50% at 85% 5%, rgba(36, 120, 255, 0.12) 0%, transparent 60%),
        ...
        .topbar-left h1 { font-size: 18px; font-weight: 700; letter-spacing: -0.3px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
        ...
        .kpi-grid-2 { display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px; margin-bottom: 24px; }
        ...
        .kpi-card.red::before    { background: linear-gradient(90deg, #ff4e6a, #cc1f3b); }
        .kpi-card:hover { background: var(--bg-card-hover); border-color: rgba(56,120,220,0.4); transform: translateY(-2px); box-shadow: 0 12px 40px rgba(4,13,26,0.4); }
        ...
        .kpi-value  { font-size: 32px; font-weight: 800; letter-spacing: -1px; line-height: 1; margin-bottom: 6px; }
        ...
        .chart-badge    { font-size: 10px; font-weight: 600; padding: 4px 10px; border-radius: 100px; background: rgba(26,110,247,0.12); border: 1px solid rgba(26,110,247,0.25); color: var(--blue-2); white-space: nowrap; }
        ...
        /* ══════════════════════════════════════
           TABLE CARD
        ══════════════════════════════════════ */
        .table-card { background: var(--bg-card); border: 1px solid var(--border); border-radius: 14px; overflow: hidden; backdrop-filter: blur(16px); margin-bottom: 24px; }
        .table-card-header { padding: 20px 24px; border-bottom: 1px solid var(--border); display: flex; align-items: center; justify-content: space-between; gap: 12px; }
        .table-title  { font-size: 14px; font-weight: 600; }
        .table-wrap   { overflow-x: auto; -webkit-overflow-scrolling: touch; }
        table         { width: 100%; border-collapse: collapse; }
        thead th { padding: 12px 20px; text-align: left; font-size: 10px; font-weight: 700; color: var(--text-muted); text-transform: uppercase; letter-spacing: 0.8px; border-bottom: 1px solid var(--border); white-space: nowrap; }
        tbody tr { border-bottom: 1px solid rgba(56,120,220,0.08); transition: background 0.15s; }
        tbody tr:last-child { border-bottom: none; }
        tbody tr:hover { background: rgba(26,110,247,0.05); }
        tbody td { padding: 12px 20px; font-size: 12px; color: var(--text-primary); vertical-align: middle; white-space: nowrap; }
        ...
        .pill-green  { background: rgba(0,212,160,0.12);  color: var(--green);  border: 1px solid rgba(0,212,160,0.25); }
        .pill-orange { background: rgba(255,140,66,0.12); color: var(--orange); border: 1px solid rgba(255,140,66,0.25); }
        .pill-red    { background: rgba(255,78,106,0.12); color: var(--red);    border: 1px solid rgba(255,78,106,0.25); }
        .pill-blue   { background: rgba(59,138,255,0.12); color: var(--blue-2); border: 1px solid rgba(59,138,255,0.25); }
        ...
        .farmacia-bar-wrap { flex: 1; height: 6px; background: rgba(56,120,220,0.12); border-radius: 10px; overflow: hidden; }
        .farmacia-bar   { height: 100%; background: linear-gradient(90deg, var(--blue-1), var(--blue-2)); border-radius: 10px; transition: width 1s ease; }
        ...
        .farmacia-count { font-size: 11px; font-weight: 700; color: var(--blue-2); min-width: 30px; text-align: right; }
        ...
        @media (max-width: 1024px) {
            ...
            /* Rendimiento: colapsar el elemento con grid-column: span 2 */
        ...
        @media (max-width: 640px) {
            ...
            .charts-grid-2 { grid-template-columns: 1fr; gap: 12px; }
...
<aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-footer">
        ...
        <form method="POST" action="{{ route('logout') }}">
            @csrf
            <button type="submit" class="btn-logout" id="btn-logout">🚪 Cerrar sesión</button>
        </form>
    </div>
</aside>
